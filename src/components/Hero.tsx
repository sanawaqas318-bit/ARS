...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Decorative Radial pattern from reference */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 flex justify-center lg:justify-end order-1 lg:order-1 relative">
            <div className="relative">
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[480px] lg:h-[480px] rounded-full overflow-hidden border-4 border-white/10 shadow-[0_0_50px_rgba(255,184,0,0.1)]">
                {profileImg && (
                  <Image 
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 md:space-y-8 order-2 lg:order-2">
            ...
            <p className="text-sm md:text-lg lg:text-xl text-white/50 max-w-lg leading-relaxed mx-auto lg:mx-0 font-medium">
