        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <div className="mt-20 flex justify-center lg:justify-start">
               <div className="w-10 h-10 border border-muted rounded-full flex items-center justify-center text-muted font-black text-xs">
                N
               </div>
            </div>
          </div>
          ...
          <div className="flex-1 relative">
            <div className="relative w-full max-w-md md:max-w-lg mx-auto aspect-square">
              {/* Profile Circle with Yellow Border */}
              <div className="relative w-full h-full rounded-full overflow-hidden border-[12px] border-card shadow-2xl">
                <div className="absolute inset-0 border-[6px] border-primary rounded-full z-20 pointer-events-none opacity-50"></div>
                {profileImg && (
                  <Image 
              ...
              {/* Experience Badge matching reference exactly */}
              <div className="absolute bottom-8 right-0 bg-card border border-white/10 p-6 rounded-3xl shadow-2xl flex flex-col items-center justify-center min-w-[140px] z-30">
                <span className="text-4xl font-black text-primary leading-none">1+</span>
                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-2 text-center">
                  Years <br /> Experience
                </span>
              </div>
            </div>
